...
public class DirectConsumers {
    ...
    public void readMessage(Message testMessage) {
        System.out.println("我是消费信息directQueue1,routingKey:direct.queue : " + new String(testMessage.getBody()));
    }

    @RabbitListener(queuesToDeclare = @Queue(value="TestDirectQueue2"))
    private void readMessage2(Message testMessage){
        System.out.println("我是消费信息directQueue2,routingKey:direct-queue : " + new String(testMessage.getBody()));
    }
